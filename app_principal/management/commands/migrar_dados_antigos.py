...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dora_enf, _ = Fornecedor.objects.get_or_create(
        ...
        # Empresa (dados do contrato)
        aglon, _ = Fornecedor.objects.get_or_create(
        ...
        # Empresa (dados do contrato)
        rioclarense, _ = Fornecedor.objects.get_or_create(
        ...
        mamed, _ = Fornecedor.objects.get_or_create(
        ...
        dimeva, _ = Fornecedor.objects.get_or_create(
